...
class MergeUserRegistrationFiles extends Command
{
    ...
    public function handle()
    {
        ...
        $files = [
            base_path('app/Application/Registration/Commands/RegisterUserCommand.php'),
            base_path('app/Application/Registration/Contracts/RegisterUserHandlerInterface.php'),
            base_path('app/Application/Registration/Handlers/RegisterUserCommandHandler.php'),
            base_path('app/Application/Shared/Enums/OperationResultEnum.php'),
            base_path('app/Application/Shared/Results/OperationResult.php'),       
            ...
            base_path('app/Domain/Registration/Contracts/UserRepositoryInterface.php'),     
            base_path('app/Domain/Registration/DTO/UserRegistrationData.php'),
            base_path('app/Domain/Registration/Exceptions/DuplicateEmailException.php'),
            base_path('app/Domain/Registration/Exceptions/UserPersistenceException.php'),
            ...
            base_path('app/Domain/Shared/Contracts/TransactionManagerInterface.php'),          
            base_path('app/Events/Registration/UserRegistered.php'),
            base_path('app/Http/Requests/CreateUserRequest.php'),
            base_path('app/Infrastructure/Registration/Repositories/EloquentUserRepository.php'),
            base_path('app/Infrastructure/Registration/Services/EmailNotificationService.php'),
            base_path('app/Infrastructure/Shared/Transaction/LaravelTransactionManager.php'),
